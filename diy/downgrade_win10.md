...
- driver problem: hp.support restricts drivers of most of the laptops to windows11; drivers compatible with windows10 is often unavailable; need to risk using disreputable apps(360DrvMng); even worse, sound drive(realtek hd audio driver or whatsoever) never works and you may need to buy an external driver-free usb audio port.
