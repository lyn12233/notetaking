...
$$\begin{cases}
    ...
    \frac{n}{\sigma^2} S_n^2 \sim \chi^2 (n-1) \\
...
3. $\sigma^2 \in \frac{(n-1){S^*}^2_n}{\chi^2_{1-\alpha/2\, \mathrm{or}\, \alpha/2} (n-1)}$

4. $\mu_1 - \mu_2 \in \overline{X}_1 -\overline{X}_2 \pm \sqrt{\frac{\sigma^2_1}{n_1} +\frac{\sigma^2_2}{n_2}} \, u_{\alpha/2}$
5. $\mu_1 - \mu2 \in \overline{X}_1 - \overline{X}_2 \pm t_{\alpha/2} (n_1+n_2-2) \sqrt{\frac{1}{n_1} + \frac{1}{n_2}} \sqrt{\frac{(n_1 -1) S_1^2 + (n_2 - 1)S_2^2}{n_1 + n_2 - 2}} \quad(\mathrm{记为} S_w)$

6. $\frac{\sigma_1^2}{\sigma_2^2} \in \frac{{S^*}_1^2}{{S^*}_2^2} \left( F_{1-\alpha/2}(n_2-1,n_1-1),\, F_{\alpha/2}(n_1-1,n_2-1) \right)$
